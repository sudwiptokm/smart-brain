...
class Register extends React.Component{
    ...
    onSubmitSignIn = () => {
        fetch("https://floating-shelf-50682.herokuapp.com/register",{
            method: "post",
                ...
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="mt3">
                            ...
                            <input 
                            className="pa2 input-reset ba bg-transparent hover-bg-black-30 hover-white w-100 white" 
                            type="text" 
                            name="name"  
                            id="name"
                        ...
                        <div className="mv3">
                            ...
                            <input 
                            className="b pa2 input-reset ba bg-transparent hover-bg-black hover-bg-black-30 w-100 white" 
                            type="password" 
                            name="password"  
                            id="password"
